...
var DropIndicator_1 = require("./DropIndicator");
...
var TreeView = /** @class */ (function (_super) {
            ...
            if (copy) {
                ...
                for (var _i = 0, srcInfos_1 = srcInfos; _i < srcInfos_1.length; _i++) {
                    ...
                    for (var i = 0; i < destPathBefore.length; ++i) {
                        ...
                        if (util_1.isPathEqual(srcParent, destAncestor) && srcIndex < destIndex_1) {
                            --destPathAfter[i];
                        }
                    }
                }
    ...
    TreeView.prototype.render = function () {
        ...
        return (React.createElement("div", { ref: function (e) { return _this.element = e; }, className: className, onDragOver: this.onDragOver, onDrop: this.onDrop, onContextMenu: this.onContextMenu },
            ...
            React.createElement(DropIndicator_1.DropIndicator, { ref: function (e) { return _this.dropIndicator = e; }, rowHeight: rowHeight, indent: indent, dropOverClassName: this.props.dropOverIndicatorClassName, dropBetweenClassName: this.props.dropBetweenIndicatorClassName })));
    };
    ...
    TreeView.prototype.renderNode = function (node, path, visible) {
        ...
        var CustomToggler = this.props.toggler || Toggler_1.Toggler;
        ...
        var row = (React.createElement("div", { key: "row-" + key, className: rowClasses, style: style, onClick: function (ev) { return _this.onClickRow(rowInfo, ev); }, draggable: true, onDragStart: onDragStart, onDragEnd: onDragEnd },
            React.createElement(CustomToggler, { visible: children != null && children.length > 0, collapsed: collapsed, onClick: onTogglerClick }),
    ...
    TreeView.prototype.keysToInfos = function (keys) {
        ...
        infos.sort(function (a, b) { return util_1.comparePaths(a.path, b.path); });
        return infos;
    };
    ...
    TreeView.prototype.getDropTarget = function (ev) {
        ...
        var overIndex = util_1.clamp(Math.floor(y / rowHeight), 0, this.visibleInfos.length);
        ...
        var betweenIndex = util_1.clamp((offset < rowHeight / 2) ? overIndex : overIndex + 1, 0, this.visibleInfos.length);
        ...
        if (0 < betweenIndex) {
            ...
            if (path.length < prevPath.length) {
                var depth = util_1.clamp(Math.floor(x / indent) - 1, path.length, prevPath.length);
